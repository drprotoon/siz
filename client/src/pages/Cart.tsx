            ...
            {authData?.user ? (
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Link href="/login">
                    <a className="bg-primary hover:bg-pink-600 text-white rounded-md py-2 px-4 text-center">
                      Entrar
                    </a>
                  </Link>
                  <Link href="/register">
                    <a className="bg-gray-800 hover:bg-gray-700 text-white rounded-md py-2 px-4 text-center">
                      Criar Conta
                    </a>
                  </Link>
                </div>
