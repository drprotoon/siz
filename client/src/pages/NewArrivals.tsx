...
export default function new_arrivals() {
  ...
  return (
    <div className="bg-background text-foreground transition-colors duration-300">
      {/* Category header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold font-heading elegant-heading">Novidades</h1>
        <p className="text-muted-foreground">Descubra os produtos mais recentes da nossa coleção</p>
      </div>
